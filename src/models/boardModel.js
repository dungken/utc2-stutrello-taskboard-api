...
const BOARD_COLLECTION_SCHEMA = Joi.object({
   ...
   * Làm như trên thì sau này dù có thêm hay sửa gì vào cái BOARD_TYPES trong file constants thì ở những chỗ dùng Joi trong Model hay Validation cũng không cần phải đụng vào nữa. Tối ưu gọn gàng luôn.
  */
